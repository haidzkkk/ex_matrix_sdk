...
class MyVoipApp implements WebRTCDelegate {
  ...
  Future<RTCPeerConnection> createPeerConnection(
      ...
      // ]) async => webrtc.RTCFactoryNative.instance.createPeerConnection(configuration, constraints);
      ]) async => MockRTCPeerConnection();


  @override
  Future<void> handleCallEnded(CallSession session) async {
    Logs().i('handleCallEnded called in MyVoipApp');
  }

  @override
  Future<void> handleGroupCallEnded(GroupCallSession groupCall) async {
    Logs().i('handleGroupCallEnded called in MyVoipApp');
  }

  @override
  Future<void> handleMissedCall(CallSession session) async {
    Logs().i('handleMissedCall called in MyVoipApp');
  }

  @override
  Future<void> handleNewCall(CallSession session) async {
    Logs().i('handleNewCall called in MyVoipApp');
    switch(session.direction) {
      case CallDirection.kIncoming:
        Logs().i('handleNewCall MyVoipApp incoming call window');
      // show incoming call window
        break;
      case CallDirection.kOutgoing: {
        Logs().i('handleNewCall MyVoipApp outgoing call window');
  ...
  Future<void> handleNewGroupCall(GroupCallSession groupCall) async {
    Logs().i('handleNewGroupCall called in MyVoipApp');
  }
  ...
  Future<void> playRingtone() async {
    Logs().i('playRingtone called in MyVoipApp');
  }

  @override
  Future<void> stopRingtone() async {
    Logs().i('stopRingtone called in MyVoipApp');
  }
...
class MockMediaDevices implements MediaDevices {
  ...
  Future<MediaStream> getUserMedia(
    ...
    return webrtc.navigator.mediaDevices.getUserMedia(mediaConstraints);
    // return MockMediaDevices().getUserMedia(mediaConstraints);
    // return MockMediaStream('_id', '_ownerTag');
  }
